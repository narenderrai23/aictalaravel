...
<div class="container pt-5">
    <div class="row pb-5 pb-lg-6 mb-lg-3">
        <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0 pr-lg-5">
            <a href="{{ asset('branch/index') }}"><img class="img-fluid mb-3 footer-logo"
                    src="{{ asset('branch/images/logo-light.svg') }}" alt=""></a>
        ...
        <div class="col-sm-6 col-lg-2 mb-4 mb-sm-0">
            ...
            <div class="footer-link">
                <ul class="list-unstyled mb-0">
                    <li><a class="text-white" href="{{ asset('branch/index') }}">Home</a></li>
                    <li><a class="text-white" href="{{ asset('branch/about-us') }}">About</a></li>
                    <li><a class="text-white" href="{{ asset('branch/course') }}">Course</a></li>
                    <li><a class="text-white" href="{{ asset('branch/privacy-policy') }}">Privacy Policy</a>
                    </li>
                    <li><a class="text-white" href="{{ asset('branch/pricing') }}">Pricing</a></li>
                    <li><a class="text-white" href="{{ asset('branch/faq') }}">Faq</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="footer-contact-info">
                <div class="contact-address mt-4">
                    ...
                    <div class="contact-item">
                        ...
                        <p class="mb-0 font-weight-bold ml-3"><a class="text-white" href="#">+(123)
                                456-7890</a></p>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12 text-center">
                <p class="mb-0 text-white">©Copyright 2020 <a href="{{ asset('branch/index') }}">academic</a>
                    All Rights
                    Reserved</p>
            </div>
        </div>
